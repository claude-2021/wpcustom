...
<div class="panel-start-quiz flex-center-column">
    ...
    <div class="btn-quiz btn-quiz-green pointer btn-startquiz"><span><?php echo $trand['Start Quiz'];?></span><img
...
<div class="panelsWrapperOuter hidden">
    ...
    <div class="panelsWrapper">
        ...
        <div class="panel hidden" step="<?php echo $i;?>">
            ...
            <div class="instructions"><?php echo $trand['Select at least one that applies to you to continue']; ?></div>
...
<div class="navig flex-raw-center hidden">
    <div class="btn-quiz prev-btn-quiz btn-quiz-white pointer"><span><?php echo $trand['Back']; ?></span><img
            src="<?php echo plugin_dir_url(__DIR__)?>img/arrow-left.png" /></div>
    <div class="btn-quiz next-btn-quiz btn-quiz-green pointer disabled"><span><?php echo $trand['Next']; ?></span><img
            src="<?php echo plugin_dir_url(__DIR__)?>img/arrow-right.png" /></div>
</div>
</div>
...
<div class="result_inner flex">
    <div class="txtc">
        <div class="big-tit"><?php echo $trand['Your Result']; ?></div>
        <div class="quote"><?php echo $trand['You don’t just live by principlesYour Result']; ?></div>
        <div class="percentage-phrase" >&nbsp;<span class="perc">61%</span>&nbsp;<span><?php echo $trand['of people get this result'];?></span>&nbsp;</div>
        <div class="share-btn flex">
            <div class="inner flex">
                <img src="<?php echo plugin_dir_url(__DIR__)?>img/share.png" width="13" height="13" />
                <span><?php echo $trand['Share']; ?></span>
            </div>
        </div>    
    </div>
    <div class="qrel">
        ...
        <div class="donateBtn"><?php echo $trand['Donate Now']; ?></div>
    </div>
</div>
</div>
</div>